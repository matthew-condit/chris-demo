    ...
    render () {
        ...
        return(
            ...
            <div className="summary__option" key={this.props.featureHash}>
                ...
                <div className="summary__option__value">{this.props.selectedOption[this.props.featureHash]}</div>
                <div className="summary__option__cost">
                    {this.props.conversion.format(this.props.selectedOption[this.props.featureHash])}
                </div>
            </div>
        )
    }
